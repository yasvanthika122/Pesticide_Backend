...
//new.
const getTotalRegisteredCustomers = async (req, res) => {
    try {
    ...
    if (req.body.email && req.body.password) {
        ...
        if (customer) {
            ...
            if (validated) {
                ...
                // Add the logged-in customer to the list
...
// Function to get the total number of logged-in customers
const getTotalLoggedInCustomers = (req, res) => {
    res.send({ totalCustomers: loggedInCustomers.length });
};
